...
check_data = ADSP_data %>% select(PHC_Diagnosis, PHC_AB42, PHC_Sex, PHC_Education,
                                  PHC_Ethnicity, PHC_Race, PHC_AGE) %>%
  filter(PHC_Diagnosis != 2) %>% na.omit()
check_data0 = check_data %>% filter(PHC_Diagnosis == "1")
check_data1 = check_data %>% filter(PHC_Diagnosis == "3")
X0 = check_data0 %>% select(PHC_Sex, PHC_Education, PHC_Ethnicity, PHC_Race, PHC_AGE)
X1 = check_data1 %>% select(PHC_Sex, PHC_Education, PHC_Ethnicity, PHC_Race, PHC_AGE)
...
ADSP_data_sub = ADSP_data %>% select(PHC_Diagnosis, PHC_AB42, PHC_Sex_New) %>%
  filter(PHC_Diagnosis != 2) %>% na.omit()
...
ADSP_data_sub = ADSP_data %>% select(PHC_Diagnosis, PHC_Tau, PHC_Sex_New) %>% na.omit()
...
ADSP_data_sub = ADSP_data %>% select(PHC_Diagnosis, PHC_pTau, PHC_Sex_New) %>% na.omit()
...
write.csv(AUC_cutoff_tab, "cov_data_analysis_AUC_cutoff_est_tab.csv")


## Plotting ROC individually

# ggsave(filename = "Plot_cov_data_analysis_AB42_ROC0.png",
#        plot = ROC.summ.tab(AB42_cov.fit$ROC0, AB42_cov.fit$ROC1)$plotROC0,
#        # width = 12, height = 16,
#        device='png', dpi=1000
# )
# ggsave(filename = "Plot_cov_data_analysis_AB42_ROC1.png",
#        plot = ROC.summ.tab(AB42_cov.fit$ROC0, AB42_cov.fit$ROC1)$plotROC1,
#        # width = 12, height = 16,
#        device='png', dpi=1000
# )
# 
# ggsave(filename = "Plot_cov_data_analysis_Tau_ROC0.png",
#        plot = ROC.summ.tab(tau_cov.fit$ROC0, tau_cov.fit$ROC1)$plotROC0,
#        # width = 12, height = 16,
#        device='png', dpi=1000
# )
# ggsave(filename = "Plot_cov_data_analysis_Tau_ROC1.png",
#        plot = ROC.summ.tab(tau_cov.fit$ROC0, tau_cov.fit$ROC1)$plotROC1,
#        # width = 12, height = 16,
#        device='png', dpi=1000
# )
# 
# ggsave(filename = "Plot_cov_data_analysis_pTau_ROC0.png",
#        plot = ROC.summ.tab(ptau_cov.fit$ROC0, ptau_cov.fit$ROC1)$plotROC0,
#        # width = 12, height = 16,
#        device='png', dpi=1000
# )
# ggsave(filename = "Plot_cov_data_analysis_pTau_ROC1.png",
#        plot = ROC.summ.tab(ptau_cov.fit$ROC0, ptau_cov.fit$ROC1)$plotROC1,
#        # width = 12, height = 16,
#        device='png', dpi=1000
# )
...
ggsave(filename = "Plot_cov_data_analysis_all_biom_ROC.png",
       plot = all.ROC.plot,
       width = 12, height = 18,
       device='png' #, dpi=1000
)
...
ggsave(filename = "Plot_cov_data_analysis_density_cutoff_AB42.png",
       plot = AB42.whole.summ$all.cutoff.plot,
       width = 12, height = 18,
       device='png' #, dpi=1000
)

ggsave(filename = "Plot_cov_data_analysis_density_cutoff_Tau.png",
       plot = Tau.whole.summ$all.cutoff.plot,
       width = 12, height = 18,
       device='png' #, dpi=1000
)

ggsave(filename = "Plot_cov_data_analysis_density_cutoff_pTau.png",
